                            ...
                            <div class="d-flex flex-column h-100">
                              ...
                              <form action="post">
                                ...
                                <div class="align-middle text-center text-sm">
                                  <a href="/update_Evenement/{{$Reservation->id }}" class="btn btn-success btn-sm">Accepter</a>
                                </div>
                                <div class="align-middle text-center text-sm">
                                    <a href="/deleteEvenement/{{$Reservation->id }}" type="button" class="btn btn-danger btn-sm">Rejecter</a>
                                </div>
