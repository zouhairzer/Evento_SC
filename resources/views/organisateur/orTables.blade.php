            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <div class="col-6 text-start mx-4">
                    <button class="btn btn-outline-primary btn-sm mb-0" data-bs-toggle="modal" data-bs-target="#exampleModal" >Ajouter</button>
                </div>
                      ...
                      <div class="modal-body">
                        <form  method="post" enctype="multipart/form-data">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" name="titre" class="form-control" value id="recipient-name">
                          </div>    
                          <div class="mb-3">
