                    ...
                    <div class="d-flex py-1">
                      ...
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-sm font-weight-normal mb-1">
                          <span class="font-weight-bold">Update User</span> from Laur
                        </h6>
    ...
    <div class="modal-content">
        ...
        <form action="/update/user" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" class="form-control" id="recipient-name" value="{{ $user->name }}">
            </div>
            <div class="mb-3">
            ...
            <select name="role_id" id="role_id" class="form-control mb-3">
                ...
                <option name="role_id" value="{{ $role->id }}">{{ $role->role }}</option>
                @endforeach
            </select>
